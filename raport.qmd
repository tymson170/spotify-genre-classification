...
```{r echo=FALSE}
file <- read.csv("data/spotify-genres-classification-new.csv")
...
grid_results <- readRDS("data/grid_results_tune_changed_ts.rds")
```
...
grid_results2 <- readRDS("data/grid_results_tune_wla.rds")
```
